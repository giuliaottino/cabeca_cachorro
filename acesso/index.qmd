  ...
  tags$details(
    ...
    tags$div(
      ...
      tags$div(
        ...
        tags$p("A lista mostra apenas nomes completos identificados em nível de espécie, já normalizados no script externo, com família associada. Clique ou passe o cursor sobre o táxon para ver seus registros; o ícone abre a página na Flora e Funga do Brasil.")
      ),
      tags$div(
          ...
          tags$article(
            ...
            tags$div(
              ...
              if (nz(dat$ffb_taxon_url[i])) tags$a(
                class = "ffb-link", href = dat$ffb_taxon_url[i],
...
<style>
  ...
  *{ box-sizing: border-box; }
  ...
  .species-taxon-trigger:focus-visible, .ffb-link:focus-visible{ outline: 2px solid var(--green); outline-offset: 4px; }
  .ffb-link{ display: inline-flex; flex: 0 0 auto; }
  .ffb-link img{ width: 28px; height: 28px; object-fit: contain; }
